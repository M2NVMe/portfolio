...
const CONFIG = {
  ...
  experiences: [
    ...
    {
      company: 'SM-Fish Fish Feeder',
      position: 'Frontend developer, QA tester',
      from: '2025',
      to: '2025',
      companyLink: '#',
    },
    {
      company: 'SkiLVul Lomba Digital Nasional',
    ...
    {
      company: 'DBS Coding Camp by Dicoding',
